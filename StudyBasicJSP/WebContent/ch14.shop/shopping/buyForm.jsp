...
if(session.getAttribute("id")==null){
	...
	<form name ="inform" method="post" action="updateCart.jsp">
		...
		<tr>
			...
			<img src="../../imageFile/<%=cartList.getBook_image() %>" border="0" width="30"
		...
		%>
		<tr>
			<td colspan="5" align="right"><b>총구매금액:
...
<br>
	<script type="text/javascript">
		function selectAccount(name){
			...
			javascript:window.location = name + "AccountForm.jsp?accountList"+accountList;
		}
	</script>
	<table>
		<tr>
