...
<table>
	<tr height="30" bgcolor="<%=value_c%>">
		<td rowspan="4" width="100">
			...
			<img 
			src="../../imageFile/<%=bookList.getBook_image() %>" border="0" width="60" height="90">
			</a>
		</td>
	...
	<tr height="30" bgcolor="<%=value_c%>">
		...
		<%=NumberFormat.getInstance().format((int)
				(bookList.getBook_price()*((double)(100-bookList.getDiscount_rate())/100)))%>	
			</font></b>
		</td>
	</tr>
</table>
